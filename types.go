...
type reader struct {
	...
	// It must only be accessed through sync/atomic. A nil pointer or a
	// stored value of 0 means no limit is enforced, matching the
	// pre-negotiation and explicitly-unlimited cases.
	maxFrameSize *uint32
}
